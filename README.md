![jcenter](https://img.shields.io/badge/_jcenter_-0.0.0.4-6688ff.png?style=flat) &#x2003; ![jcenter](https://img.shields.io/badge/_Tests_-69/69-green.png?style=flat)
# Asynk MYSQL
...
[Download](https://bintray.com/artifact/download/programingjd/maven/info/jdavid/asynk/mysql/0.0.0.4/mysql-0.0.0.4.jar) the latest jar.
...
```
dependencies {
  compile 'info.jdavid.asynk:mysql:0.0.0.4'
}
```
