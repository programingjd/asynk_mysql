![jcenter](https://img.shields.io/badge/_jcenter_-0.0.0.15-6688ff.png?style=flat) &#x2003; ![jcenter](https://img.shields.io/badge/_Tests_-105/105-green.png?style=flat)
# Asynk MYSQL
...
[Download](https://bintray.com/artifact/download/programingjd/maven/info/jdavid/asynk/mysql/0.0.0.15/mysql-0.0.0.15.jar) the latest jar.
...
```
dependencies {
  compile 'info.jdavid.asynk:mysql:0.0.0.15'
}
```
